...
import { fetchOpenF1Meetings, fetchOpenF1Sessions, fetchOpenF1Drivers, } from "../sources/openf1.js";
const SOURCE = "openf1";
...
async function enrichDrivers(year) {
...
async function enrichMeetings(year) {
...
async function enrichSessions(year) {
    ...
    for (const s of sessions) {
        ...
        const existing = await prisma.session.findFirst({
            where: { eventId: event.id, type: sessionType },
        });
        if (existing) {
...
//# sourceMappingURL=sync-openf1.js.map